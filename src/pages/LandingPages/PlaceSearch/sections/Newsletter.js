...
// Images
import macbook from "assets/images/food_transparent.png";
        ...
        <Grid container alignItems="center">
          <Grid item md={6} sx={{ ml: { xs: 0, lg: 3 }, mb: { xs: 12, md: 0 } }}>
            ...
            <MKTypography variant="body2" color="text" mb={3}>
              Subscribe to follow more news so as not to miss any new news.
            </MKTypography>
          ...
          <Grid item xs={12} md={5} sx={{ ml: "auto" }}>
            <MKBox position="relative">
              <MKBox component="img" src={macbook} alt="food" width="100%" />
            </MKBox>
          </Grid>
        </Grid>
      </Container>
